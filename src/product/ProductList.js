        ...
        <div className="filter-flex-container">
          ...
          <div className="filter-container">
            ...
            <ButtonGroup id="sortBy" className="filter" >
              <Button variant="primary" id={selectedSort==="Alpha AZ" ? "isSelected" : ""} name="Alpha AZ" onClick={(e) => {setSelectedSort(e.target.name)}}>Alphabetical<br/>(A-Z)</Button>
              <Button variant="primary" id={selectedSort==="Alpha ZA" ? "isSelected" : ""} name="Alpha ZA" onClick={(e) => {setSelectedSort(e.target.name)}}>Alphabetical<br/>(Z-A)</Button>
              <Button variant="primary" id={selectedSort==="Date Asc" ? "isSelected" : ""}  name="Date Asc" onClick={(e) => {setSelectedSort(e.target.name)}}>Date Added<br/>(old - new)</Button>
              <Button variant="primary" id={selectedSort==="Date Desc" ? "isSelected" : ""} name="Date Desc" onClick={(e) => {setSelectedSort(e.target.name)}}>Date Added<br/>(new - old)</Button>
            </ButtonGroup>
            &nbsp;
